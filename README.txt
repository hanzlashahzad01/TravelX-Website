...
Multi-page navigation with a consistent navbar linking to all pages.



Mobile-first responsive design with media queries (992px, 768px, 576px).
...
Flexbox for navbar, contact form, and section layouts; CSS Grid for card-based sections (destinations, features, testimonials, packages).



Neon aesthetic with glowing text animations, hover transitions (scale and shadow), and gradient backgrounds.
...
Reusable header and footer across all pages with social media links (Facebook, TikTok, Instagram).



Transitions on buttons and cards for interactive feel.



Static contact form with name, email, phone, travel date, and message fields.
...
Save all HTML files and css/style.css in the respective folders.



Unsplash image URLs are used for backgrounds; for offline use, download images and place them in assets/images/, updating URLs in HTML.
...
The contact form is static (non-functional) as per requirements.
...
Social media links are included in the footer as provided by the user.



Images are sourced from Unsplash for reliability; local images can be used by updating URLs.

Created by: [Hanzla Shahzad] Date: July 19, 2025
